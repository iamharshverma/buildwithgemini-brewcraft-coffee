...
def get_memory_service():
    """Process-wide memory service using Vertex AI Memory Bank when deployed."""
    ...
    if agent_engine_id:
        ...
        project = (
            ...
            or "qwiklabs-gcp-04-623529d65701"
        )
        location = (
            os.environ.get("MEMORY_BANK_LOCATION")
